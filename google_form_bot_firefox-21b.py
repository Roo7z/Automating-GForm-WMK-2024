...
def fill_form():
    ...
    time.sleep(2)
    option_xpath = "/html/body/div[1]/div[2]/form/div[2]/div/div[2]/div[1]/div/div/div[2]/div/div[2]/div[37]/span"
...
def countdown(seconds):
    while seconds:
        ...
        print(f"Menunggu selama {timer}...", end="\r")
        time.sleep(1)
        seconds -= 1
    print("Waktu tunggu selesai!             ")  # Membersihkan baris tampilan

# Perulangan pengisian formulir
try:
    for _ in range(100):  # Isi sesuai jumlah iterasi yang diinginkan
        fill_form()
        print("Form selesai diisi. Menunggu 5 menit...")
        #time.sleep(300)  # Jeda 5 menit
        countdown(300)  # Jeda 5 menit dengan hitungan mundur
finally:
    driver.quit()
